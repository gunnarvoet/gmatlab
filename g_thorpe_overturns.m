function ctd = g_thorpe_overturns(ctd)

% ctd = g_thorpe_overturns(ctd) Calculate epsilon and k_rho from overturns
%
%     CTD = g_thorpe_overturns(CTD) calculates Thorpe length scales and
%     turbulent dissipation from overturns using the Ferron method. Also,
%     using fix instead of round as suggested by Glenn Carter.
%
%     fmt: Ferron et al. (1998) using temperature
%     fmd: Ferron method using density
%
